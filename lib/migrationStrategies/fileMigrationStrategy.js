...
var fileMigrationStrategy = {
    ...
    migrate: function (migrationSet, direction, migrationName) {
...
function getMigrationsFor(migrationSet, direction, migrationName) {
    var migrationsFnsForDirection,
        migrationPos = migrationPosition(migrationSet, direction, migrationName);
...
function migrationPosition(migrationSet, direction, migrationName) {
    var migrationPos;
