...
var fileMigrationStrategy = function(migrationSet, direction, migrationName) {
    ...
    fs.readFile(migrationSet.path, 'utf8', function (err, json) {
        ...
        var migrationSetFromFile = JSON.parse(json);
        ...
        _migrate(migrationSet, direction, migrationFunction, migrationName);
    });
};
...
function _migrate(migrationSet, direction, fn, migrationName) {
